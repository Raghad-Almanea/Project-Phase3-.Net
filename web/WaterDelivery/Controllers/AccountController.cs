...
namespace WaterDelivery.Controllers
{
    ...
    public class AccountController : Controller
    {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (model.Img != null)
                {
                    ...
                    if (file != null)
                    {
                        ...
                        string path = Path.Combine(Server.MapPath("~/Content/Img/User"), fileName);
                        file.SaveAs(path);
                        model.Img = fileName;
                    }
                }
                ...
                var user = new ApplicationUser { UserName = model.Email, Email = model.Email, FullName = model.FullName, PasswordHash = model.Password, Img = model.Img, Type = 1,FkCity = model.FkCity };
        ...
        [HttpPost]
        public ActionResult UpdateUser(EditViewModel model)
        {
            ApplicationDbContext context = new ApplicationDbContext();
            ApplicationUser userEmail = context.Users.FirstOrDefault(u => u.Email == model.Email && u.Id != model.Id);
            ...
            if (model.Img != null)
            {
                ...
                if (file != null)
                {
                    ...
                    string fileName = DateTime.Now.Ticks.ToString() + count + ".jpg";
        ...
        public async Task<ActionResult> ForgotPassword(ForgotPasswordViewModel model)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                SendMailToCompany("", callbackUrl, model.Email);
